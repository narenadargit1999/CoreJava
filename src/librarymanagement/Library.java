...
public class Library {
	...
	private static void addIssueDetails() {
		BookIssueDetails bd1 = new BookIssueDetails(1,"abc",1,new Date("05/05/2022"));
	...
	private static void issueBook() {
		System.out.println("Enter User Id,Booknumber, name and issuse Date(dd-mm-yyyy)format");
		Scanner sc1 = new Scanner(System.in);
		Scanner sc2=new Scanner(System.in);
		System.out.println("enter user id");
		int UserId = sc1.nextInt();
		System.out.println("enter book id");
		int bookNumber = sc1.nextInt();
		System.out.println("enter name of book");
		String name = sc2.nextLine();
		System.out.println("enter issuse date");
		String issueDate = sc1.nextLine();
